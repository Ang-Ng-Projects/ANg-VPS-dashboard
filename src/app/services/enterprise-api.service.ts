...
export class EnterpriseApiService {
  ...
  getLabList(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getLabAPI.processId;
      const workflowId = this.apiService.api.getLabAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  getHospitalList(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getHospitalAPI.processId;
      const workflowId = this.apiService.api.getHospitalAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  getAnaLive(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getAnaLiveAPI.processId;
      const workflowId = this.apiService.api.getAnaLiveAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  getAnaVis(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getAnaVisAPI.processId;
      const workflowId = this.apiService.api.getAnaVisAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  getAnaAgent(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getAnaAgentAPI.processId;
      const workflowId = this.apiService.api.getAnaAgentAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  getChart(data) {
    return new Promise((resolve, reject) => {
      ...
      this.httpService.post(url, body, true).toPromise().then((res) => {
        resolve(res)
        console.log("getChart response", res);
      }).catch((rejectRes) => {
        reject(rejectRes);
        console.log("Error in getChart", rejectRes);
      });
  ...
  getAppAnaChart(data) {
    return new Promise((resolve, reject) => {
      const processData = data;
      const processId = this.apiService.api.getAnaAppChartData.processId;
      const workflowId = this.apiService.api.getAnaAppChartData.workflowId;
      const projectId = environment.projectIds.vps;
      const body: RequestEntity = {
        processId: processId,
        ProcessVariables: processData,
  ...
  getPaitentAnaChart(data) {
    return new Promise((resolve, reject) => {
      const processData = data;
      const processId = this.apiService.api.getAnaPatientChartData.processId;
      const workflowId = this.apiService.api.getAnaPatientChartData.workflowId;
      const projectId = environment.projectIds.vps;
      const body: RequestEntity = {
        processId: processId,
        ProcessVariables: processData,
  ...
  getLanguageAnaChart(data) {
    return new Promise((resolve, reject) => {
      const processData = data;
      const processId = this.apiService.api.getLangAnaChartData.processId;
      const workflowId = this.apiService.api.getLangAnaChartData.workflowId;
      const projectId = environment.projectIds.vps;
      const body: RequestEntity = {
        processId: processId,
        ProcessVariables: processData,
  ...
  liveAgentCsvDownload(config: any): Observable<any> {

    let encoded = encodeURIComponent(config);
    const url = `https://burjeelholdings.karix.ae/appiyo/d/download/csv?&content_var=attachmentContent&filename=report.csv&more_flag_var=more&processVariables=${encoded}`;

    var res = this.http.get(url, { responseType: 'text' })
    return res;
  }

  // serviceCSV(config: any): Observable<any> {
  //   const url = ${environment.baseURL}service_Report_APIs;
  ...
  appointmentCsvDownload(config: any): Observable<any> {
    ...
    //   const url = `https://appiyo.karix.solutions/appiyo/d/download/csv?&content_var=attachmentContent&filename=report.csv&more_flag_var=more&processVariables=${encoded}`;
  ...
  conversationCsvDownload(config: any): Observable<any> {
    const processId = this.apiService.api.appoitmentCsv.processId;
    const workflowId = this.apiService.api.appoitmentCsv.workflowId;
    const projectId = environment.projectIds.vps;
    let encoded = encodeURIComponent(config);
  ...
  feedbackCsvDownload(config: any): Observable<any> {
    const processId = this.apiService.api.appoitmentCsv.processId;
    const workflowId = this.apiService.api.appoitmentCsv.workflowId;
    const projectId = environment.projectIds.vps;
    let encoded = encodeURIComponent(config);
  ...
  // milestoneCsvDownload(config: any): Observable<any> {
  ...
  activityCsvDownload(config: any): Observable<any> {
    const processId = this.apiService.api.appoitmentCsv.processId;
    const workflowId = this.apiService.api.appoitmentCsv.workflowId;
    const projectId = environment.projectIds.vps;
    let encoded = encodeURIComponent(config);
  ...
  getPatientFilter(data) {
    return new Promise((resolve, reject) => {
      const processData = data;
      const processId = this.apiService.api.patient.processId;
      const workflowId = this.apiService.api.patient.workflowId;
      const projectId = environment.projectIds.vps;
      const body: RequestEntity = {
        processId: processId,
        ProcessVariables: processData,
  ...
  getFacilityFilter(data) {
    return new Promise((resolve, reject) => {
      const processData = data;
      const processId = this.apiService.api.facilityFilter.processId;
      const workflowId = this.apiService.api.facilityFilter.workflowId;
      const projectId = environment.projectIds.vps;
      const body: RequestEntity = {
        processId: processId,
        ProcessVariables: processData,
  ...
  getpharmacyList(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.getpharmacyAPI.processId;
      const workflowId = this.apiService.api.getpharmacyAPI.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  pharmacyAgentCsvDownload(config: any): Observable<any> {
  ...
  remainderAppointmentList(searchData?: any) {
    return new Promise((resolve, reject) => {
      const processId = this.apiService.api.RemainderAppointmentId.processId;
      const workflowId = this.apiService.api.RemainderAppointmentId.workflowId;
      const projectId = environment.projectIds.vps;
  ...
  remainderAppointmentCsvDownload(config: any): Observable<any> {

    let encoded = encodeURIComponent(config);
    const url = `https://burjeelholdings.karix.ae/appiyo/d/download/csv?&content_var=outputString&filename=report.csv&more_flag_var=more&processVariables=${encoded}`;
