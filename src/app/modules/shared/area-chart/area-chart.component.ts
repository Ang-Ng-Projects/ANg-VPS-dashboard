...
export class AreaChartComponent implements OnInit {
  ...
  async getChart() {
    ...
    try {
      ...
      console.log("payloadbooking", params)
      const response: any = await this.enterpriseApiService.getChart(params);
      // console.log('getChartareachart', response, params, !this.fromDate);
      console.log('getChartareachart', response);
      ...
      if (appiyoError == '0') {
        ...
        console.log('Process Variables:', this.processVariables);
        console.log('xAxis:', this.processVariables?.xAxis);
        console.log('Total Average:', this.processVariables?.totalAverage);
        console.log('Graph Count List:', this.processVariables?.graphDateList);
        console.table(this.processVariables?.graphDateList); // optional, formatted table view
        ...
        console.log('Final X Axis Labels:', this.lineChartLabels);
        console.log('Final Y Axis Data:', this.chartOptions.series[0].data);
      }
      else {
