...
export class StackedChartComponent implements OnInit {
  ...
  async getChart() {
    try {
      ...
      console.log('getChartfeedback', response ,params, !this.fromDate);
      ...
      if (appiyoError == '0' && apiErrorCode == "200") {
        ...
        if (this.xAxis == '3' && !this.fromDate) {          
            ...
            this.chartOptions.series[0].data = yAxisOk;
            this.chartOptions.series[1].data = yAxisGood;
            this.chartOptions.series[2].data = yAxisBad;
            this.chartOptions.series[3].data = yAxisGreat;
          }
